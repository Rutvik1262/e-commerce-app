...
export class UserProfileComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    console.log("this.user_data...",this.userProfileForm);
    this.editUserData(this.user_data)
  ...
  editUserData(user_id: any) {
    this.userService.getUserData(user_id).subscribe(data => {
      console.log("user_id....",this.userService);
      this.user_data = data;
  ...
  updateProfile() {
     ...
     console.log("userProfile....", this.userProfileForm);
     
    if (this.userProfileForm.invalid) {
      alert('error' + JSON.stringify(this.userProfileForm));
      return;
    }
    ...
    this.user_dto = {
      ...
      uploadphoto: (this.user_update_data.uploadphoto == "" ? this.user_profile_pic : this.
        user_update_data.uploadphoto),
